...
export class Home extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <a href="/petitions" className="btn btn-info m-2">Go to Petitions page</a>
                ...
                <div style={{ backgroundColor: "#2B5678", padding: "1rem" }}>
                    <h3>Why lumine8?</h3>
                    <div className="d-flex flexGroup" style={{ flexDirection: "row" }}>
                        <div className="card">
                ...
                <div style={{ padding: "1rem", backgroundColor: "#2B5678" }}>
                    <h3>About</h3>
                    <div className="d-flex flexGroup" style={{ flexDirection: "row" }}>
                        <div className="card">
                ...
                <div style={{ padding: "1rem" }}>
                    ...
                    <div className="d-flex flexGroup" style={{ flexDirection: "row" }} >
                        <div className="card">
                            ...
                            <a href="downloads/com.lumine8.lumine8_maui-Signed.apk" style={button} className="btn btn-primary ms-2 mb-2" download="lumine8.apk">Download</a>
                        ...
                        <div className="card">
                            ...
                            <a href="downloads/lumine8.exe" style={button} className="btn btn-primary ms-2 mb-2" download="lumine8.exe">Download</a>
                ...
                <div style={{ backgroundColor: "#2B5678", padding: "1rem" }}>
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <a style={link} className="link" href="https://github.com/ParkerRedford/lumine8-client">Client</a>
                            <a style={link} className="mx-2 link" href="https://github.com/ParkerRedford/lumine8-web">Server</a>
                            <a style={link} className="link" href="https://github.com/ParkerRedford/lumine8-shared">Shared</a>
                        </div>
                    </div>
                </div>
            </div>
