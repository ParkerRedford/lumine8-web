...
namespace lumine8.Server.Hubs
{
    public class Chat : Hub
    {
        ...
        /*private bool Authorize(LoginUser user, string Username)
        {
            *//*var Username = re.GetHttpContext().Request.Headers["Username"].FirstOrDefault();
            var token = re.GetHttpContext().Request.Headers["Token"].FirstOrDefault();
            var password = re.GetHttpContext().Request.Headers["Password"].FirstOrDefault();*//*
